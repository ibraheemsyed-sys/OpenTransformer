...
\title{OpenTransformer: Building and Verifying a Tiled 4$\times$4 Systolic Array Accelerator}

\author{
\IEEEauthorblockN{Ibraheem Syed}
\IEEEauthorblockA{
...
The main idea in this milestone is hardware reuse. A full physical 16$\times$16 systolic array would need 256 processing elements. That would be much larger. OpenTransformer uses a 4$\times$4 physical systolic array with 16 processing elements. The larger 16$\times$16 workload is completed by reusing that smaller array across multiple tiles.
